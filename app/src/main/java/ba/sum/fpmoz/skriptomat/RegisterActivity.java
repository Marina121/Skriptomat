...
import ba.sum.fpmoz.skriptomat.databinding.ActivityRegisterBinding;
...
public class RegisterActivity extends AppCompatActivity {
    ...
    private String fullNameTxt = "", phoneTxt = "", registerEmailTxt = "", registerPasswordTxt = "", registerPasswordCnfTxt = "", numberIndx="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseReference reference = database.getReference("Profil");
    ...
    private void imgPickIntent() {
        Log.d(TAG, "imgPickIntent: početak odabira");
        Intent intent = new Intent();
        intent.setType("image/*");
        intent.setAction(Intent.ACTION_GET_CONTENT);
        startActivityForResult(Intent.createChooser(intent, "Odaberi"), IMG_PICK_CODE);
    }
    ...
    private void validateData() {
        ...
        numberIndx = binding.numberIndx.getText().toString().trim();

        if (TextUtils.isEmpty(fullNameTxt)) {
            Toast.makeText(this, "Unesi ime i prezime", Toast.LENGTH_SHORT).show();
            Log.d(TAG, "validateData: prazno");
        ...
        }else if (TextUtils.isEmpty(numberIndx)) {
            Toast.makeText(this, "Unesite broj indexa!", Toast.LENGTH_SHORT).show();
        } else if (imgUri == null) {
                                        ...
                                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                if (task.isSuccessful()) {
                                                    ...
                                                    Toast.makeText(RegisterActivity.this, "Slanje email za verifikaciju nije uspjelo!", Toast.LENGTH_SHORT).show();
                                                }
                                            }
                                        });
    ...
    private void uploadFilesToStorage() {
        ...
        String filePathAndName = "Profil/files/" + registerEmailTxt;
    ...
    private void uploadDataToDb(String uploadedImgUrl, String registerEmailTxt) {
        ...
        hashMap.put("phoneTxt", "" + phoneTxt);
        hashMap.put("numberIndx",""+ numberIndx);
        hashMap.put("uid", "" + uid);

        DatabaseReference ref = FirebaseDatabase.getInstance("https://skriptomat-5acff-default-rtdb.europe-west1.firebasedatabase.app/").getReference("Profil");
